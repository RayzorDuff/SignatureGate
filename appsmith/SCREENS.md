...
## 2) Members
- ✔️List + filters (active/inactive)
- ✔️Member detail: contact info, agreements, releases, donations
- Actions: 
	✔️create member, 
	deactivate, 
	merge duplicates
